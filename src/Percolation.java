...
public class Percolation {
	...
	/*
	 * Data structure containing the sites sites is an array representing a 2D
	...
	public Percolation(int N) {
		 ...
		 * 
		 * 0 = the first site to determine percolation N*N + 1 = the last site
		 */
	...
	public void open(int i, int j) {
		...
		if (sites[index] == 0) {
			...
			/*
			 * if in first row use the union-find structure to join to the
			 * 0-site
			 */
			if (i == 1) {
				S.union(0, index);
